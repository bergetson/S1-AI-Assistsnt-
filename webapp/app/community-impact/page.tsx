...
import { ImpactBadge, PrototypeNotice, DemoPill } from '@/components/shared/Badges'
...
export default function CommunityImpactPage() {
  ...
  function exportSummary() {
    downloadCsv('community-impact-summary.csv',
      ...
      isDemo ? 'DEMO DATA — synthetic, not real personnel. Potential community impact estimate only.' : undefined)
  }
