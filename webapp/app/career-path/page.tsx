...
// The Career Path Sequencer has been consolidated into the Career Planner.
export default function CareerPathRedirect() {
  const router = useRouter()
  useEffect(() => { router.replace('/planner') }, [router])
  return (
    <div className="max-w-xl mx-auto mt-24 text-center px-4">
      <p className="text-gray-600">
        The Career Path tool is now part of the{' '}
