...
const FEATURES = [
  ...
  },
  {
    ...
    desc: '1,184 real MTARNG positions — 625 currently vacant — scored 0–100 against your profile. Filter by city, grade, status, and vacancy. See gap analysis on every card.',
